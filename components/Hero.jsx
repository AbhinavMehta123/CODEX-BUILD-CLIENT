...
export default function CodexCircuitHero() {
    ...
    return (
        <section id="home"
            ...
            /* ADDED: pt-24 for mobile to clear navbar, items-start lg:items-center for better mobile flow */
            className="relative min-h-screen w-full flex items-start lg:items-center bg-[#02040a] overflow-hidden px-6 lg:px-24 font-mono pt-24 lg:pt-0"
        >
            ...
            <div className="container mx-auto grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-12 lg:gap-12 items-center relative z-10">

                {/* LEFT: MISSION CONTROL */}
                <motion.div
                    initial={{ opacity: 0, y: 20 }} // Changed x to y for better mobile entrance
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 1 }}
                    /* ADDED: text-center lg:text-left for mobile alignment */
                ...
                >
                    ...
                    <div className="flex flex-col items-center lg:items-start justify-center text-center lg:text-left">
                        ...
                        {/* Paragraph with the border-left accent from your screenshot */}
                        <p className="text-slate-400 text-sm lg:text-lg max-w-md mx-auto lg:mx-0 mb-10 lg:mb-12 border-none lg:border-l-2 border-cyan-500/30 lg:pl-6 leading-relaxed">
                            The ultimate build-a-thon for high-performance engineers.
                            110 minutes. Infinite logic. Zero downtime.
                        </p>

                        {/* The Button: Now aligned with the para on desktop, centered on mobile */}
                ...
                >
                    {/* Animated Rings - Hidden on small mobile to prevent overflow, visible on lg */}
                    <motion.div
                        animate={{ rotate: 360 }}
                    ...
                    {/* Floating Data Point - Adjusted for mobile */}
                    <motion.div
                        animate={{ y: [0, -10, 0] }}
                    ...
                    >
                        <div className="text-[8px] lg:text-[10px] text-cyan-500 font-bold tracking-tighter uppercase">Latency</div>
                        <div className="text-lg lg:text-xl text-white font-black leading-none">0.04ms</div>
                    </motion.div>
                </motion.div>
            ...
            {/* BOTTOM GRID FLOOR */}
            <div className="absolute bottom-0 left-0 w-full h-32 lg:h-48 bg-[linear-gradient(to_right,#1e293b_1px,transparent_1px),linear-gradient(to_bottom,#1e293b_1px,transparent_1px)] bg-[size:30px_30px] lg:bg-[size:40px_40px] opacity-10 [mask-image:linear-gradient(to_top,black,transparent)]" />
        </section>
    );
}